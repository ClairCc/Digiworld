...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        messages: {
            'default': 'Arrastre y suelte un archivo aquí o haga clic aqui',
        ...
        error: {
            ...
            'imageFormat': 'El formato de imagen no está permitido ({{ value }} solo).',
            'fileExtension': 'El archivo no está permitido ({{ value }} solor).'
        },
        tpl: {
